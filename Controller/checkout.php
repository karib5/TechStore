...
@include 'config.php';
require_once '../Model/checkout_query.php';
...
<section class="display-orders">
   ...
   <?php
      $cart_grand_total = 0;
      $select_cart_items = getCartItemsByUser($user_id);
...
<section class="checkout-orders">
   ...
   <form action="" method="POST">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>state :</span>
            <input type="text" name="state" placeholder="Dhaka Division" class="box" required>
         </div>
         <div class="inputBox">
            <span>country :</span>
